document.addEventListener('DOMContentLoaded', function () {
  ...
  function initCartForm () {
    ...
    const submitButton = cartForm
      ? cartForm.querySelector('.add-to-cart-btn')
      : null
    ...
    cartForm.addEventListener('submit', function (event) {
      ...
      if (
        typeof window.getCart !== 'function' ||
        typeof window.saveCart !== 'function'
      ) {
  ...
  async function initCatalogPage () {
    ...
    if (relatedProducts) {
      relatedProducts.innerHTML = generateProductCards(
        products,
        'You May Also Like'
      )
    }
  ...
  function initStarRatingInput () {
    ...
    const ratingSpan = ratingContainer
      ? ratingContainer.querySelector('span')
      : null
